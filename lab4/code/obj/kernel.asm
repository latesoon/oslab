...
ffffffffc0200048:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc020004a:	677040ef          	jal	ra,ffffffffc0204ec0 <memset>
...
ffffffffc0200056:	ebe58593          	addi	a1,a1,-322 # ffffffffc0204f10 <etext+0x2>
ffffffffc020005a:	00005517          	auipc	a0,0x5
ffffffffc020005e:	ed650513          	addi	a0,a0,-298 # ffffffffc0204f30 <etext+0x22>
...
ffffffffc020007a:	62c040ef          	jal	ra,ffffffffc02046a6 <proc_init>
...
ffffffffc020008e:	067040ef          	jal	ra,ffffffffc02048f4 <cpu_idle>
...
ffffffffc02000ac:	e9050513          	addi	a0,a0,-368 # ffffffffc0204f38 <etext+0x2a>
...
ffffffffc0200172:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc0200174:	14f040ef          	jal	ra,ffffffffc0204ac2 <vprintfmt>
    return cnt;
}
...
ffffffffc02001a8:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02001aa:	119040ef          	jal	ra,ffffffffc0204ac2 <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc02001ce:	d7650513          	addi	a0,a0,-650 # ffffffffc0204f40 <etext+0x32>
void print_kerninfo(void) {
...
ffffffffc02001e4:	d8050513          	addi	a0,a0,-640 # ffffffffc0204f60 <etext+0x52>
ffffffffc02001e8:	f99ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc02001ec:	00005597          	auipc	a1,0x5
ffffffffc02001f0:	d2258593          	addi	a1,a1,-734 # ffffffffc0204f0e <etext>
ffffffffc02001f4:	00005517          	auipc	a0,0x5
ffffffffc02001f8:	d8c50513          	addi	a0,a0,-628 # ffffffffc0204f80 <etext+0x72>
...
ffffffffc020020c:	d9850513          	addi	a0,a0,-616 # ffffffffc0204fa0 <etext+0x92>
...
ffffffffc0200220:	da450513          	addi	a0,a0,-604 # ffffffffc0204fc0 <etext+0xb2>
...
ffffffffc020024e:	d9650513          	addi	a0,a0,-618 # ffffffffc0204fe0 <etext+0xd2>
}
...
ffffffffc020025c:	db860613          	addi	a2,a2,-584 # ffffffffc0205010 <etext+0x102>
ffffffffc0200260:	04d00593          	li	a1,77
ffffffffc0200264:	00005517          	auipc	a0,0x5
ffffffffc0200268:	dc450513          	addi	a0,a0,-572 # ffffffffc0205028 <etext+0x11a>
void print_stackframe(void) {
...
ffffffffc0200278:	dcc60613          	addi	a2,a2,-564 # ffffffffc0205040 <etext+0x132>
ffffffffc020027c:	00005597          	auipc	a1,0x5
ffffffffc0200280:	de458593          	addi	a1,a1,-540 # ffffffffc0205060 <etext+0x152>
ffffffffc0200284:	00005517          	auipc	a0,0x5
ffffffffc0200288:	de450513          	addi	a0,a0,-540 # ffffffffc0205068 <etext+0x15a>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc0200296:	de660613          	addi	a2,a2,-538 # ffffffffc0205078 <etext+0x16a>
ffffffffc020029a:	00005597          	auipc	a1,0x5
ffffffffc020029e:	e0658593          	addi	a1,a1,-506 # ffffffffc02050a0 <etext+0x192>
ffffffffc02002a2:	00005517          	auipc	a0,0x5
ffffffffc02002a6:	dc650513          	addi	a0,a0,-570 # ffffffffc0205068 <etext+0x15a>
ffffffffc02002aa:	ed7ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
ffffffffc02002ae:	00005617          	auipc	a2,0x5
ffffffffc02002b2:	e0260613          	addi	a2,a2,-510 # ffffffffc02050b0 <etext+0x1a2>
ffffffffc02002b6:	00005597          	auipc	a1,0x5
ffffffffc02002ba:	e1a58593          	addi	a1,a1,-486 # ffffffffc02050d0 <etext+0x1c2>
ffffffffc02002be:	00005517          	auipc	a0,0x5
ffffffffc02002c2:	daa50513          	addi	a0,a0,-598 # ffffffffc0205068 <etext+0x15a>
...
ffffffffc02002fc:	de850513          	addi	a0,a0,-536 # ffffffffc02050e0 <etext+0x1d2>
kmonitor(struct trapframe *tf) {
...
ffffffffc020031e:	dee50513          	addi	a0,a0,-530 # ffffffffc0205108 <etext+0x1fa>
...
ffffffffc0200348:	dec90913          	addi	s2,s2,-532 # ffffffffc0205130 <etext+0x222>
        while (*buf != '\0' && strchr(WHITESPACE, *buf) != NULL) {
ffffffffc020034c:	00005497          	auipc	s1,0x5
ffffffffc0200350:	dec48493          	addi	s1,s1,-532 # ffffffffc0205138 <etext+0x22a>
        if (argc == MAXARGS - 1) {
ffffffffc0200354:	49bd                	li	s3,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc0200356:	00005b17          	auipc	s6,0x5
ffffffffc020035a:	deab0b13          	addi	s6,s6,-534 # ffffffffc0205140 <etext+0x232>
        argv[argc ++] = buf;
ffffffffc020035e:	00005a17          	auipc	s4,0x5
ffffffffc0200362:	d02a0a13          	addi	s4,s4,-766 # ffffffffc0205060 <etext+0x152>
    for (i = 0; i < NCOMMANDS; i ++) {
...
ffffffffc020038c:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc020038e:	2ff040ef          	jal	ra,ffffffffc0204e8c <strcmp>
...
ffffffffc02003a0:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02003a2:	2eb040ef          	jal	ra,ffffffffc0204e8c <strcmp>
...
ffffffffc02003e0:	2cb040ef          	jal	ra,ffffffffc0204eaa <strchr>
...
ffffffffc020041e:	28d040ef          	jal	ra,ffffffffc0204eaa <strchr>
...
ffffffffc020043c:	d2850513          	addi	a0,a0,-728 # ffffffffc0205160 <etext+0x252>
...
ffffffffc020058a:	e406                	sd	ra,8(sp)
    memcpy(dst, &ide[iobase], nsecs * SECTSIZE);
ffffffffc020058c:	147040ef          	jal	ra,ffffffffc0204ed2 <memcpy>
    return 0;
}
...
ffffffffc02005ae:	e406                	sd	ra,8(sp)
    memcpy(&ide[iobase], src, nsecs * SECTSIZE);
ffffffffc02005b0:	123040ef          	jal	ra,ffffffffc0204ed2 <memcpy>
    return 0;
}
...
ffffffffc0200c2e:	3c663603          	ld	a2,966(a2) # ffffffffc0206ff0 <nbase>
...
ffffffffc02016f4:	9006b683          	ld	a3,-1792(a3) # ffffffffc0206ff0 <nbase>
...
ffffffffc0201968:	68c53503          	ld	a0,1676(a0) # ffffffffc0206ff0 <nbase>
...
ffffffffc0201bbe:	302030ef          	jal	ra,ffffffffc0204ec0 <memset>
    return page - pages + nbase;
...
ffffffffc0201c50:	270030ef          	jal	ra,ffffffffc0204ec0 <memset>
    return page - pages + nbase;
...
ffffffffc0202352:	329020ef          	jal	ra,ffffffffc0204e7a <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0202356:	10040593          	addi	a1,s0,256
ffffffffc020235a:	10000513          	li	a0,256
ffffffffc020235e:	32f020ef          	jal	ra,ffffffffc0204e8c <strcmp>
...
ffffffffc0202390:	10068023          	sb	zero,256(a3)
    assert(strlen((const char *)0x100) == 0);
ffffffffc0202394:	2b1020ef          	jal	ra,ffffffffc0204e44 <strlen>
...
ffffffffc0202e2c:	1c860613          	addi	a2,a2,456 # ffffffffc0206ff0 <nbase>
...
ffffffffc0203cc2:	332a3a03          	ld	s4,818(s4) # ffffffffc0206ff0 <nbase>
...
ffffffffc0204080:	ad450513          	addi	a0,a0,-1324 # ffffffffc0206b50 <default_pmm_manager+0xef0>
...
ffffffffc0204092:	a7250513          	addi	a0,a0,-1422 # ffffffffc0206b00 <default_pmm_manager+0xea0>
...
ffffffffc02040a2:	ada50513          	addi	a0,a0,-1318 # ffffffffc0206b78 <default_pmm_manager+0xf18>
...
ffffffffc02040b2:	a8250513          	addi	a0,a0,-1406 # ffffffffc0206b30 <default_pmm_manager+0xed0>
...
ffffffffc02040e4:	ac060613          	addi	a2,a2,-1344 # ffffffffc0206ba0 <default_pmm_manager+0xf40>
ffffffffc02040e8:	45b5                	li	a1,13
ffffffffc02040ea:	00003517          	auipc	a0,0x3
ffffffffc02040ee:	ad650513          	addi	a0,a0,-1322 # ffffffffc0206bc0 <default_pmm_manager+0xf60>
...
ffffffffc020411e:	ed673703          	ld	a4,-298(a4) # ffffffffc0206ff0 <nbase>
...
ffffffffc0204158:	a8460613          	addi	a2,a2,-1404 # ffffffffc0206bd8 <default_pmm_manager+0xf78>
ffffffffc020415c:	45d1                	li	a1,20
ffffffffc020415e:	00003517          	auipc	a0,0x3
ffffffffc0204162:	a6250513          	addi	a0,a0,-1438 # ffffffffc0206bc0 <default_pmm_manager+0xf60>
...
ffffffffc0204174:	b2860613          	addi	a2,a2,-1240 # ffffffffc0205c98 <default_pmm_manager+0x38>
ffffffffc0204178:	00002517          	auipc	a0,0x2
ffffffffc020417c:	b4850513          	addi	a0,a0,-1208 # ffffffffc0205cc0 <default_pmm_manager+0x60>
...
ffffffffc02041ac:	e4873703          	ld	a4,-440(a4) # ffffffffc0206ff0 <nbase>
...
ffffffffc02041e6:	9f660613          	addi	a2,a2,-1546 # ffffffffc0206bd8 <default_pmm_manager+0xf78>
ffffffffc02041ea:	45e5                	li	a1,25
ffffffffc02041ec:	00003517          	auipc	a0,0x3
ffffffffc02041f0:	9d450513          	addi	a0,a0,-1580 # ffffffffc0206bc0 <default_pmm_manager+0xf60>
...
ffffffffc0204202:	a9a60613          	addi	a2,a2,-1382 # ffffffffc0205c98 <default_pmm_manager+0x38>
ffffffffc0204206:	00002517          	auipc	a0,0x2
ffffffffc020420a:	aba50513          	addi	a0,a0,-1350 # ffffffffc0205cc0 <default_pmm_manager+0x60>
...
ffffffffc0204214:	9402                	jalr	s0
	...
	jal do_exit
ffffffffc0204216:	474000ef          	jal	ra,ffffffffc020468a <do_exit>
...
ffffffffc0204250:	471000ef          	jal	ra,ffffffffc0204ec0 <memset>
        proc->tf = NULL;
        proc->cr3 = boot_cr3;
...
ffffffffc020426e:	453000ef          	jal	ra,ffffffffc0204ec0 <memset>
    }
    return proc;
}
...
ffffffffc02042d8:	94c50513          	addi	a0,a0,-1716 # ffffffffc0206c20 <default_pmm_manager+0xfc0>
ffffffffc02042dc:	ea5fb0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("To U: \"en.., Bye, Bye. :)\"\n");
ffffffffc02042e0:	00003517          	auipc	a0,0x3
ffffffffc02042e4:	95050513          	addi	a0,a0,-1712 # ffffffffc0206c30 <default_pmm_manager+0xfd0>
...
ffffffffc020433c:	5d4000ef          	jal	ra,ffffffffc0204910 <switch_to>
    if (flag) {
...
ffffffffc0204374:	24f75863          	bge	a4,a5,ffffffffc02045c4 <do_fork+0x25a>
{
ffffffffc0204378:	1101                	addi	sp,sp,-32
ffffffffc020437a:	e822                	sd	s0,16(sp)
ffffffffc020437c:	e426                	sd	s1,8(sp)
ffffffffc020437e:	e04a                	sd	s2,0(sp)
ffffffffc0204380:	ec06                	sd	ra,24(sp)
ffffffffc0204382:	84ae                	mv	s1,a1
ffffffffc0204384:	8432                	mv	s0,a2
    if ((proc = alloc_proc()) == NULL) //���䲢��ʼ�����̿��ƿ飨alloc_proc������
ffffffffc0204386:	e95ff0ef          	jal	ra,ffffffffc020421a <alloc_proc>
ffffffffc020438a:	892a                	mv	s2,a0
ffffffffc020438c:	24050163          	beqz	a0,ffffffffc02045ce <do_fork+0x264>
    struct Page *page = alloc_pages(KSTACKPAGE);
ffffffffc0204390:	4509                	li	a0,2
ffffffffc0204392:	e9afd0ef          	jal	ra,ffffffffc0201a2c <alloc_pages>
    if (page != NULL) {
ffffffffc0204396:	1e050163          	beqz	a0,ffffffffc0204578 <do_fork+0x20e>
    return page - pages + nbase;
...
ffffffffc02043ac:	c4853503          	ld	a0,-952(a0) # ffffffffc0206ff0 <nbase>
...
ffffffffc02043c0:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc02043c2:	22e7f863          	bgeu	a5,a4,ffffffffc02045f2 <do_fork+0x288>
    assert(current->mm == NULL);
ffffffffc02043c6:	00011797          	auipc	a5,0x11
ffffffffc02043ca:	1ea7b783          	ld	a5,490(a5) # ffffffffc02155b0 <current>
ffffffffc02043ce:	779c                	ld	a5,40(a5)
ffffffffc02043d0:	00011717          	auipc	a4,0x11
ffffffffc02043d4:	1b073703          	ld	a4,432(a4) # ffffffffc0215580 <va_pa_offset>
ffffffffc02043d8:	96ba                	add	a3,a3,a4
        proc->kstack = (uintptr_t)page2kva(page);
ffffffffc02043da:	00d93823          	sd	a3,16(s2)
    assert(current->mm == NULL);
ffffffffc02043de:	1e079a63          	bnez	a5,ffffffffc02045d2 <do_fork+0x268>
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE - sizeof(struct trapframe));
ffffffffc02043e2:	6789                	lui	a5,0x2
ffffffffc02043e4:	ee078793          	addi	a5,a5,-288 # 1ee0 <kern_entry-0xffffffffc01fe120>
ffffffffc02043e8:	96be                	add	a3,a3,a5
    *(proc->tf) = *tf;
ffffffffc02043ea:	8622                	mv	a2,s0
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE - sizeof(struct trapframe));
ffffffffc02043ec:	0ad93023          	sd	a3,160(s2)
    *(proc->tf) = *tf;
ffffffffc02043f0:	87b6                	mv	a5,a3
ffffffffc02043f2:	12040893          	addi	a7,s0,288
ffffffffc02043f6:	00063803          	ld	a6,0(a2)
ffffffffc02043fa:	6608                	ld	a0,8(a2)
ffffffffc02043fc:	6a0c                	ld	a1,16(a2)
ffffffffc02043fe:	6e18                	ld	a4,24(a2)
ffffffffc0204400:	0107b023          	sd	a6,0(a5)
ffffffffc0204404:	e788                	sd	a0,8(a5)
ffffffffc0204406:	eb8c                	sd	a1,16(a5)
ffffffffc0204408:	ef98                	sd	a4,24(a5)
ffffffffc020440a:	02060613          	addi	a2,a2,32
ffffffffc020440e:	02078793          	addi	a5,a5,32
ffffffffc0204412:	ff1612e3          	bne	a2,a7,ffffffffc02043f6 <do_fork+0x8c>
    proc->tf->gpr.a0 = 0;
ffffffffc0204416:	0406b823          	sd	zero,80(a3)
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc020441a:	10048e63          	beqz	s1,ffffffffc0204536 <do_fork+0x1cc>
ffffffffc020441e:	ea84                	sd	s1,16(a3)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc0204420:	00000797          	auipc	a5,0x0
ffffffffc0204424:	e5c78793          	addi	a5,a5,-420 # ffffffffc020427c <forkret>
ffffffffc0204428:	02f93823          	sd	a5,48(s2)
    proc->context.sp = (uintptr_t)(proc->tf);
ffffffffc020442c:	02d93c23          	sd	a3,56(s2)
    if (read_csr(sstatus) & SSTATUS_SIE) {
...
ffffffffc0204436:	4481                	li	s1,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204438:	10079f63          	bnez	a5,ffffffffc0204556 <do_fork+0x1ec>
    if (++ last_pid >= MAX_PID) {
...
ffffffffc0204448:	6709                	lui	a4,0x2
ffffffffc020444a:	0017851b          	addiw	a0,a5,1
ffffffffc020444e:	00a82023          	sw	a0,0(a6)
ffffffffc0204452:	06e55b63          	bge	a0,a4,ffffffffc02044c8 <do_fork+0x15e>
    if (last_pid >= next_safe) {
ffffffffc0204456:	00006317          	auipc	t1,0x6
ffffffffc020445a:	c0630313          	addi	t1,t1,-1018 # ffffffffc020a05c <next_safe.0>
ffffffffc020445e:	00032783          	lw	a5,0(t1)
ffffffffc0204462:	00011417          	auipc	s0,0x11
ffffffffc0204466:	0c640413          	addi	s0,s0,198 # ffffffffc0215528 <proc_list>
ffffffffc020446a:	06f55763          	bge	a0,a5,ffffffffc02044d8 <do_fork+0x16e>
        proc->pid = get_pid();
ffffffffc020446e:	00a92223          	sw	a0,4(s2)
    list_add(hash_list + pid_hashfn(proc->pid), &(proc->hash_link));
ffffffffc0204472:	45a9                	li	a1,10
ffffffffc0204474:	2501                	sext.w	a0,a0
ffffffffc0204476:	5ca000ef          	jal	ra,ffffffffc0204a40 <hash32>
ffffffffc020447a:	02051793          	slli	a5,a0,0x20
ffffffffc020447e:	01c7d513          	srli	a0,a5,0x1c
ffffffffc0204482:	0000d797          	auipc	a5,0xd
ffffffffc0204486:	09678793          	addi	a5,a5,150 # ffffffffc0211518 <hash_list>
ffffffffc020448a:	953e                	add	a0,a0,a5
    __list_add(elm, listelm, listelm->next);
ffffffffc020448c:	6514                	ld	a3,8(a0)
ffffffffc020448e:	0d890793          	addi	a5,s2,216
ffffffffc0204492:	6418                	ld	a4,8(s0)
    prev->next = next->prev = elm;
ffffffffc0204494:	e29c                	sd	a5,0(a3)
ffffffffc0204496:	e51c                	sd	a5,8(a0)
    elm->next = next;
ffffffffc0204498:	0ed93023          	sd	a3,224(s2)
        list_add(&proc_list, &(proc->list_link));//���̱�
ffffffffc020449c:	0c890793          	addi	a5,s2,200
    elm->prev = prev;
ffffffffc02044a0:	0ca93c23          	sd	a0,216(s2)
    prev->next = next->prev = elm;
ffffffffc02044a4:	e31c                	sd	a5,0(a4)
ffffffffc02044a6:	e41c                	sd	a5,8(s0)
    elm->next = next;
ffffffffc02044a8:	0ce93823          	sd	a4,208(s2)
    elm->prev = prev;
ffffffffc02044ac:	0c893423          	sd	s0,200(s2)
    if (flag) {
ffffffffc02044b0:	e4dd                	bnez	s1,ffffffffc020455e <do_fork+0x1f4>
    wakeup_proc(proc);
ffffffffc02044b2:	854a                	mv	a0,s2
ffffffffc02044b4:	4c6000ef          	jal	ra,ffffffffc020497a <wakeup_proc>
    ret = proc->pid;
ffffffffc02044b8:	00492503          	lw	a0,4(s2)
}
ffffffffc02044bc:	60e2                	ld	ra,24(sp)
ffffffffc02044be:	6442                	ld	s0,16(sp)
ffffffffc02044c0:	64a2                	ld	s1,8(sp)
ffffffffc02044c2:	6902                	ld	s2,0(sp)
ffffffffc02044c4:	6105                	addi	sp,sp,32
ffffffffc02044c6:	8082                	ret
        last_pid = 1;
ffffffffc02044c8:	4785                	li	a5,1
ffffffffc02044ca:	00f82023          	sw	a5,0(a6)
        goto inside;
ffffffffc02044ce:	4505                	li	a0,1
ffffffffc02044d0:	00006317          	auipc	t1,0x6
ffffffffc02044d4:	b8c30313          	addi	t1,t1,-1140 # ffffffffc020a05c <next_safe.0>
    return listelm->next;
ffffffffc02044d8:	00011417          	auipc	s0,0x11
ffffffffc02044dc:	05040413          	addi	s0,s0,80 # ffffffffc0215528 <proc_list>
ffffffffc02044e0:	00843e03          	ld	t3,8(s0)
        next_safe = MAX_PID;
ffffffffc02044e4:	6789                	lui	a5,0x2
ffffffffc02044e6:	00f32023          	sw	a5,0(t1)
ffffffffc02044ea:	86aa                	mv	a3,a0
ffffffffc02044ec:	4581                	li	a1,0
        while ((le = list_next(le)) != list) {
ffffffffc02044ee:	6e89                	lui	t4,0x2
ffffffffc02044f0:	068e0f63          	beq	t3,s0,ffffffffc020456e <do_fork+0x204>
ffffffffc02044f4:	88ae                	mv	a7,a1
ffffffffc02044f6:	87f2                	mv	a5,t3
ffffffffc02044f8:	6609                	lui	a2,0x2
ffffffffc02044fa:	a811                	j	ffffffffc020450e <do_fork+0x1a4>
            else if (proc->pid > last_pid && next_safe > proc->pid) {
ffffffffc02044fc:	00e6d663          	bge	a3,a4,ffffffffc0204508 <do_fork+0x19e>
ffffffffc0204500:	00c75463          	bge	a4,a2,ffffffffc0204508 <do_fork+0x19e>
ffffffffc0204504:	863a                	mv	a2,a4
ffffffffc0204506:	4885                	li	a7,1
ffffffffc0204508:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc020450a:	00878d63          	beq	a5,s0,ffffffffc0204524 <do_fork+0x1ba>
            if (proc->pid == last_pid) {
ffffffffc020450e:	f3c7a703          	lw	a4,-196(a5) # 1f3c <kern_entry-0xffffffffc01fe0c4>
ffffffffc0204512:	fed715e3          	bne	a4,a3,ffffffffc02044fc <do_fork+0x192>
                if (++ last_pid >= next_safe) {
ffffffffc0204516:	2685                	addiw	a3,a3,1
ffffffffc0204518:	04c6d663          	bge	a3,a2,ffffffffc0204564 <do_fork+0x1fa>
ffffffffc020451c:	679c                	ld	a5,8(a5)
ffffffffc020451e:	4585                	li	a1,1
        while ((le = list_next(le)) != list) {
ffffffffc0204520:	fe8797e3          	bne	a5,s0,ffffffffc020450e <do_fork+0x1a4>
ffffffffc0204524:	c581                	beqz	a1,ffffffffc020452c <do_fork+0x1c2>
ffffffffc0204526:	00d82023          	sw	a3,0(a6)
ffffffffc020452a:	8536                	mv	a0,a3
ffffffffc020452c:	f40881e3          	beqz	a7,ffffffffc020446e <do_fork+0x104>
ffffffffc0204530:	00c32023          	sw	a2,0(t1)
ffffffffc0204534:	bf2d                	j	ffffffffc020446e <do_fork+0x104>
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc0204536:	84b6                	mv	s1,a3
ffffffffc0204538:	ea84                	sd	s1,16(a3)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc020453a:	00000797          	auipc	a5,0x0
ffffffffc020453e:	d4278793          	addi	a5,a5,-702 # ffffffffc020427c <forkret>
ffffffffc0204542:	02f93823          	sd	a5,48(s2)
    proc->context.sp = (uintptr_t)(proc->tf);
ffffffffc0204546:	02d93c23          	sd	a3,56(s2)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc020454a:	100027f3          	csrr	a5,sstatus
ffffffffc020454e:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc0204550:	4481                	li	s1,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204552:	ee0785e3          	beqz	a5,ffffffffc020443c <do_fork+0xd2>
        intr_disable();
ffffffffc0204556:	86cfc0ef          	jal	ra,ffffffffc02005c2 <intr_disable>
        return 1;
ffffffffc020455a:	4485                	li	s1,1
ffffffffc020455c:	b5c5                	j	ffffffffc020443c <do_fork+0xd2>
        intr_enable();
ffffffffc020455e:	85efc0ef          	jal	ra,ffffffffc02005bc <intr_enable>
ffffffffc0204562:	bf81                	j	ffffffffc02044b2 <do_fork+0x148>
                    if (last_pid >= MAX_PID) {
ffffffffc0204564:	01d6c363          	blt	a3,t4,ffffffffc020456a <do_fork+0x200>
                        last_pid = 1;
ffffffffc0204568:	4685                	li	a3,1
                    goto repeat;
ffffffffc020456a:	4585                	li	a1,1
ffffffffc020456c:	b751                	j	ffffffffc02044f0 <do_fork+0x186>
ffffffffc020456e:	cda9                	beqz	a1,ffffffffc02045c8 <do_fork+0x25e>
ffffffffc0204570:	00d82023          	sw	a3,0(a6)
    return last_pid;
ffffffffc0204574:	8536                	mv	a0,a3
ffffffffc0204576:	bde5                	j	ffffffffc020446e <do_fork+0x104>
    free_pages(kva2page((void *)(proc->kstack)), KSTACKPAGE);
ffffffffc0204578:	01093683          	ld	a3,16(s2)
    return pa2page(PADDR(kva));
ffffffffc020457c:	c02007b7          	lui	a5,0xc0200
ffffffffc0204580:	0af6e163          	bltu	a3,a5,ffffffffc0204622 <do_fork+0x2b8>
ffffffffc0204584:	00011797          	auipc	a5,0x11
ffffffffc0204588:	ffc7b783          	ld	a5,-4(a5) # ffffffffc0215580 <va_pa_offset>
ffffffffc020458c:	40f687b3          	sub	a5,a3,a5
    if (PPN(pa) >= npage) {
ffffffffc0204590:	83b1                	srli	a5,a5,0xc
ffffffffc0204592:	00011717          	auipc	a4,0x11
ffffffffc0204596:	fd673703          	ld	a4,-42(a4) # ffffffffc0215568 <npage>
ffffffffc020459a:	06e7f863          	bgeu	a5,a4,ffffffffc020460a <do_fork+0x2a0>
    return &pages[PPN(pa) - nbase];
ffffffffc020459e:	00003717          	auipc	a4,0x3
ffffffffc02045a2:	a5273703          	ld	a4,-1454(a4) # ffffffffc0206ff0 <nbase>
ffffffffc02045a6:	8f99                	sub	a5,a5,a4
ffffffffc02045a8:	079a                	slli	a5,a5,0x6
ffffffffc02045aa:	00011517          	auipc	a0,0x11
ffffffffc02045ae:	fc653503          	ld	a0,-58(a0) # ffffffffc0215570 <pages>
ffffffffc02045b2:	953e                	add	a0,a0,a5
ffffffffc02045b4:	4589                	li	a1,2
ffffffffc02045b6:	d08fd0ef          	jal	ra,ffffffffc0201abe <free_pages>
    kfree(proc);
ffffffffc02045ba:	854a                	mv	a0,s2
ffffffffc02045bc:	b42fd0ef          	jal	ra,ffffffffc02018fe <kfree>
    ret = -E_NO_MEM;
ffffffffc02045c0:	5571                	li	a0,-4
    goto fork_out;
ffffffffc02045c2:	bded                	j	ffffffffc02044bc <do_fork+0x152>
    int ret = -E_NO_FREE_PROC;
ffffffffc02045c4:	556d                	li	a0,-5
}
ffffffffc02045c6:	8082                	ret
    return last_pid;
ffffffffc02045c8:	00082503          	lw	a0,0(a6)
ffffffffc02045cc:	b54d                	j	ffffffffc020446e <do_fork+0x104>
    ret = -E_NO_MEM;
ffffffffc02045ce:	5571                	li	a0,-4
    return ret;
ffffffffc02045d0:	b5f5                	j	ffffffffc02044bc <do_fork+0x152>
    assert(current->mm == NULL);
ffffffffc02045d2:	00002697          	auipc	a3,0x2
ffffffffc02045d6:	67e68693          	addi	a3,a3,1662 # ffffffffc0206c50 <default_pmm_manager+0xff0>
ffffffffc02045da:	00001617          	auipc	a2,0x1
ffffffffc02045de:	2d660613          	addi	a2,a2,726 # ffffffffc02058b0 <commands+0x738>
ffffffffc02045e2:	0fd00593          	li	a1,253
ffffffffc02045e6:	00002517          	auipc	a0,0x2
ffffffffc02045ea:	68250513          	addi	a0,a0,1666 # ffffffffc0206c68 <default_pmm_manager+0x1008>
ffffffffc02045ee:	e59fb0ef          	jal	ra,ffffffffc0200446 <__panic>
    return KADDR(page2pa(page));
ffffffffc02045f2:	00001617          	auipc	a2,0x1
ffffffffc02045f6:	6a660613          	addi	a2,a2,1702 # ffffffffc0205c98 <default_pmm_manager+0x38>
ffffffffc02045fa:	06900593          	li	a1,105
ffffffffc02045fe:	00001517          	auipc	a0,0x1
ffffffffc0204602:	6c250513          	addi	a0,a0,1730 # ffffffffc0205cc0 <default_pmm_manager+0x60>
ffffffffc0204606:	e41fb0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc020460a:	00001617          	auipc	a2,0x1
ffffffffc020460e:	75e60613          	addi	a2,a2,1886 # ffffffffc0205d68 <default_pmm_manager+0x108>
ffffffffc0204612:	06200593          	li	a1,98
ffffffffc0204616:	00001517          	auipc	a0,0x1
ffffffffc020461a:	6aa50513          	addi	a0,a0,1706 # ffffffffc0205cc0 <default_pmm_manager+0x60>
ffffffffc020461e:	e29fb0ef          	jal	ra,ffffffffc0200446 <__panic>
    return pa2page(PADDR(kva));
ffffffffc0204622:	00001617          	auipc	a2,0x1
ffffffffc0204626:	71e60613          	addi	a2,a2,1822 # ffffffffc0205d40 <default_pmm_manager+0xe0>
ffffffffc020462a:	06e00593          	li	a1,110
ffffffffc020462e:	00001517          	auipc	a0,0x1
ffffffffc0204632:	69250513          	addi	a0,a0,1682 # ffffffffc0205cc0 <default_pmm_manager+0x60>
...
ffffffffc0204650:	fe06                	sd	ra,312(sp)
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc0204652:	06f000ef          	jal	ra,ffffffffc0204ec0 <memset>
...
ffffffffc0204672:	ba478793          	addi	a5,a5,-1116 # ffffffffc0204212 <kernel_thread_entry>
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc0204676:	4581                	li	a1,0
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc0204678:	e63e                	sd	a5,264(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc020467a:	cf1ff0ef          	jal	ra,ffffffffc020436a <do_fork>
}
...
ffffffffc0204690:	5f460613          	addi	a2,a2,1524 # ffffffffc0206c80 <default_pmm_manager+0x1020>
ffffffffc0204694:	15300593          	li	a1,339
ffffffffc0204698:	00002517          	auipc	a0,0x2
ffffffffc020469c:	5d050513          	addi	a0,a0,1488 # ffffffffc0206c68 <default_pmm_manager+0x1008>
do_exit(int error_code) {
ffffffffc02046a0:	e406                	sd	ra,8(sp)
    panic("process exit!!.\n");
ffffffffc02046a2:	da5fb0ef          	jal	ra,ffffffffc0200446 <__panic>
...
proc_init(void) 
{
ffffffffc02046a6:	7179                	addi	sp,sp,-48
ffffffffc02046a8:	ec26                	sd	s1,24(sp)
    elm->prev = elm->next = elm;
ffffffffc02046aa:	00011797          	auipc	a5,0x11
ffffffffc02046ae:	e7e78793          	addi	a5,a5,-386 # ffffffffc0215528 <proc_list>
ffffffffc02046b2:	f406                	sd	ra,40(sp)
ffffffffc02046b4:	f022                	sd	s0,32(sp)
ffffffffc02046b6:	e84a                	sd	s2,16(sp)
ffffffffc02046b8:	e44e                	sd	s3,8(sp)
ffffffffc02046ba:	0000d497          	auipc	s1,0xd
ffffffffc02046be:	e5e48493          	addi	s1,s1,-418 # ffffffffc0211518 <hash_list>
...
ffffffffc02046ca:	e5270713          	addi	a4,a4,-430 # ffffffffc0215518 <name.2>
ffffffffc02046ce:	87a6                	mv	a5,s1
ffffffffc02046d0:	e79c                	sd	a5,8(a5)
ffffffffc02046d2:	e39c                	sd	a5,0(a5)
ffffffffc02046d4:	07c1                	addi	a5,a5,16
ffffffffc02046d6:	fef71de3          	bne	a4,a5,ffffffffc02046d0 <proc_init+0x2a>
    {
        list_init(hash_list + i);
    }

    if ((idleproc = alloc_proc()) == NULL) {
ffffffffc02046da:	b41ff0ef          	jal	ra,ffffffffc020421a <alloc_proc>
ffffffffc02046de:	00011917          	auipc	s2,0x11
ffffffffc02046e2:	eda90913          	addi	s2,s2,-294 # ffffffffc02155b8 <idleproc>
ffffffffc02046e6:	00a93023          	sd	a0,0(s2)
ffffffffc02046ea:	18050d63          	beqz	a0,ffffffffc0204884 <proc_init+0x1de>
...
ffffffffc02046f2:	95cfd0ef          	jal	ra,ffffffffc020184e <kmalloc>
    memset(context_mem, 0, sizeof(struct context));
ffffffffc02046f6:	07000613          	li	a2,112
ffffffffc02046fa:	4581                	li	a1,0
    int *context_mem = (int*) kmalloc(sizeof(struct context));
ffffffffc02046fc:	842a                	mv	s0,a0
    memset(context_mem, 0, sizeof(struct context));
ffffffffc02046fe:	7c2000ef          	jal	ra,ffffffffc0204ec0 <memset>
    int context_init_flag = memcmp(&(idleproc->context), context_mem, sizeof(struct context));
ffffffffc0204702:	00093503          	ld	a0,0(s2)
ffffffffc0204706:	85a2                	mv	a1,s0
ffffffffc0204708:	07000613          	li	a2,112
ffffffffc020470c:	03050513          	addi	a0,a0,48
ffffffffc0204710:	7da000ef          	jal	ra,ffffffffc0204eea <memcmp>
ffffffffc0204714:	89aa                	mv	s3,a0

    int *proc_name_mem = (int*) kmalloc(PROC_NAME_LEN);
ffffffffc0204716:	453d                	li	a0,15
ffffffffc0204718:	936fd0ef          	jal	ra,ffffffffc020184e <kmalloc>
    memset(proc_name_mem, 0, PROC_NAME_LEN);
ffffffffc020471c:	463d                	li	a2,15
ffffffffc020471e:	4581                	li	a1,0
    int *proc_name_mem = (int*) kmalloc(PROC_NAME_LEN);
ffffffffc0204720:	842a                	mv	s0,a0
    memset(proc_name_mem, 0, PROC_NAME_LEN);
ffffffffc0204722:	79e000ef          	jal	ra,ffffffffc0204ec0 <memset>
    int proc_name_flag = memcmp(&(idleproc->name), proc_name_mem, PROC_NAME_LEN);
ffffffffc0204726:	00093503          	ld	a0,0(s2)
ffffffffc020472a:	463d                	li	a2,15
ffffffffc020472c:	85a2                	mv	a1,s0
ffffffffc020472e:	0b450513          	addi	a0,a0,180
ffffffffc0204732:	7b8000ef          	jal	ra,ffffffffc0204eea <memcmp>

    if(idleproc->cr3 == boot_cr3 && idleproc->tf == NULL && !context_init_flag
ffffffffc0204736:	00093783          	ld	a5,0(s2)
ffffffffc020473a:	00011717          	auipc	a4,0x11
ffffffffc020473e:	e1e73703          	ld	a4,-482(a4) # ffffffffc0215558 <boot_cr3>
ffffffffc0204742:	77d4                	ld	a3,168(a5)
ffffffffc0204744:	0ee68463          	beq	a3,a4,ffffffffc020482c <proc_init+0x186>
...
ffffffffc0204748:	4709                	li	a4,2
ffffffffc020474a:	e398                	sd	a4,0(a5)
    idleproc->kstack = (uintptr_t)bootstack;
ffffffffc020474c:	00003717          	auipc	a4,0x3
ffffffffc0204750:	8b470713          	addi	a4,a4,-1868 # ffffffffc0207000 <bootstack>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0204754:	0b478413          	addi	s0,a5,180
    idleproc->kstack = (uintptr_t)bootstack;
...
ffffffffc020475c:	cf98                	sw	a4,24(a5)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc020475e:	4641                	li	a2,16
ffffffffc0204760:	4581                	li	a1,0
ffffffffc0204762:	8522                	mv	a0,s0
ffffffffc0204764:	75c000ef          	jal	ra,ffffffffc0204ec0 <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc0204768:	463d                	li	a2,15
ffffffffc020476a:	00002597          	auipc	a1,0x2
ffffffffc020476e:	55e58593          	addi	a1,a1,1374 # ffffffffc0206cc8 <default_pmm_manager+0x1068>
ffffffffc0204772:	8522                	mv	a0,s0
ffffffffc0204774:	75e000ef          	jal	ra,ffffffffc0204ed2 <memcpy>
    set_proc_name(idleproc, "idle");
    nr_process ++;
ffffffffc0204778:	00011717          	auipc	a4,0x11
ffffffffc020477c:	e5070713          	addi	a4,a4,-432 # ffffffffc02155c8 <nr_process>
ffffffffc0204780:	431c                	lw	a5,0(a4)

    current = idleproc;
ffffffffc0204782:	00093683          	ld	a3,0(s2)

    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc0204786:	4601                	li	a2,0
    nr_process ++;
ffffffffc0204788:	2785                	addiw	a5,a5,1
    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc020478a:	00002597          	auipc	a1,0x2
ffffffffc020478e:	54658593          	addi	a1,a1,1350 # ffffffffc0206cd0 <default_pmm_manager+0x1070>
ffffffffc0204792:	00000517          	auipc	a0,0x0
ffffffffc0204796:	af850513          	addi	a0,a0,-1288 # ffffffffc020428a <init_main>
    nr_process ++;
ffffffffc020479a:	c31c                	sw	a5,0(a4)
    current = idleproc;
ffffffffc020479c:	00011797          	auipc	a5,0x11
ffffffffc02047a0:	e0d7ba23          	sd	a3,-492(a5) # ffffffffc02155b0 <current>
    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc02047a4:	e97ff0ef          	jal	ra,ffffffffc020463a <kernel_thread>
ffffffffc02047a8:	842a                	mv	s0,a0
    if (pid <= 0) {
ffffffffc02047aa:	0ea05963          	blez	a0,ffffffffc020489c <proc_init+0x1f6>
    if (0 < pid && pid < MAX_PID) {
ffffffffc02047ae:	6789                	lui	a5,0x2
ffffffffc02047b0:	fff5071b          	addiw	a4,a0,-1
ffffffffc02047b4:	17f9                	addi	a5,a5,-2
ffffffffc02047b6:	2501                	sext.w	a0,a0
ffffffffc02047b8:	02e7e363          	bltu	a5,a4,ffffffffc02047de <proc_init+0x138>
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc02047bc:	45a9                	li	a1,10
ffffffffc02047be:	282000ef          	jal	ra,ffffffffc0204a40 <hash32>
ffffffffc02047c2:	02051793          	slli	a5,a0,0x20
ffffffffc02047c6:	01c7d693          	srli	a3,a5,0x1c
ffffffffc02047ca:	96a6                	add	a3,a3,s1
ffffffffc02047cc:	87b6                	mv	a5,a3
        while ((le = list_next(le)) != list) {
ffffffffc02047ce:	a029                	j	ffffffffc02047d8 <proc_init+0x132>
            if (proc->pid == pid) {
ffffffffc02047d0:	f2c7a703          	lw	a4,-212(a5) # 1f2c <kern_entry-0xffffffffc01fe0d4>
ffffffffc02047d4:	0a870563          	beq	a4,s0,ffffffffc020487e <proc_init+0x1d8>
    return listelm->next;
ffffffffc02047d8:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc02047da:	fef69be3          	bne	a3,a5,ffffffffc02047d0 <proc_init+0x12a>
    return NULL;
ffffffffc02047de:	4781                	li	a5,0
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc02047e0:	0b478493          	addi	s1,a5,180
ffffffffc02047e4:	4641                	li	a2,16
ffffffffc02047e6:	4581                	li	a1,0
        panic("create init_main failed.\n");
    }

    initproc = find_proc(pid);
ffffffffc02047e8:	00011417          	auipc	s0,0x11
ffffffffc02047ec:	dd840413          	addi	s0,s0,-552 # ffffffffc02155c0 <initproc>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc02047f0:	8526                	mv	a0,s1
    initproc = find_proc(pid);
ffffffffc02047f2:	e01c                	sd	a5,0(s0)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc02047f4:	6cc000ef          	jal	ra,ffffffffc0204ec0 <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc02047f8:	463d                	li	a2,15
ffffffffc02047fa:	00002597          	auipc	a1,0x2
ffffffffc02047fe:	50658593          	addi	a1,a1,1286 # ffffffffc0206d00 <default_pmm_manager+0x10a0>
ffffffffc0204802:	8526                	mv	a0,s1
ffffffffc0204804:	6ce000ef          	jal	ra,ffffffffc0204ed2 <memcpy>
    set_proc_name(initproc, "init");

    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc0204808:	00093783          	ld	a5,0(s2)
ffffffffc020480c:	c7e1                	beqz	a5,ffffffffc02048d4 <proc_init+0x22e>
ffffffffc020480e:	43dc                	lw	a5,4(a5)
ffffffffc0204810:	e3f1                	bnez	a5,ffffffffc02048d4 <proc_init+0x22e>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc0204812:	601c                	ld	a5,0(s0)
ffffffffc0204814:	c3c5                	beqz	a5,ffffffffc02048b4 <proc_init+0x20e>
ffffffffc0204816:	43d8                	lw	a4,4(a5)
ffffffffc0204818:	4785                	li	a5,1
ffffffffc020481a:	08f71d63          	bne	a4,a5,ffffffffc02048b4 <proc_init+0x20e>
}
ffffffffc020481e:	70a2                	ld	ra,40(sp)
ffffffffc0204820:	7402                	ld	s0,32(sp)
ffffffffc0204822:	64e2                	ld	s1,24(sp)
ffffffffc0204824:	6942                	ld	s2,16(sp)
ffffffffc0204826:	69a2                	ld	s3,8(sp)
ffffffffc0204828:	6145                	addi	sp,sp,48
ffffffffc020482a:	8082                	ret
    if(idleproc->cr3 == boot_cr3 && idleproc->tf == NULL && !context_init_flag
ffffffffc020482c:	73d8                	ld	a4,160(a5)
ffffffffc020482e:	ff09                	bnez	a4,ffffffffc0204748 <proc_init+0xa2>
ffffffffc0204830:	f0099ce3          	bnez	s3,ffffffffc0204748 <proc_init+0xa2>
        && idleproc->state == PROC_UNINIT && idleproc->pid == -1 && idleproc->runs == 0
ffffffffc0204834:	6394                	ld	a3,0(a5)
ffffffffc0204836:	577d                	li	a4,-1
ffffffffc0204838:	1702                	slli	a4,a4,0x20
ffffffffc020483a:	f0e697e3          	bne	a3,a4,ffffffffc0204748 <proc_init+0xa2>
ffffffffc020483e:	4798                	lw	a4,8(a5)
ffffffffc0204840:	f00714e3          	bnez	a4,ffffffffc0204748 <proc_init+0xa2>
        && idleproc->kstack == 0 && idleproc->need_resched == 0 && idleproc->parent == NULL
ffffffffc0204844:	6b98                	ld	a4,16(a5)
ffffffffc0204846:	f00711e3          	bnez	a4,ffffffffc0204748 <proc_init+0xa2>
ffffffffc020484a:	4f98                	lw	a4,24(a5)
ffffffffc020484c:	2701                	sext.w	a4,a4
ffffffffc020484e:	ee071de3          	bnez	a4,ffffffffc0204748 <proc_init+0xa2>
ffffffffc0204852:	7398                	ld	a4,32(a5)
ffffffffc0204854:	ee071ae3          	bnez	a4,ffffffffc0204748 <proc_init+0xa2>
        && idleproc->mm == NULL && idleproc->flags == 0 && !proc_name_flag
ffffffffc0204858:	7798                	ld	a4,40(a5)
ffffffffc020485a:	ee0717e3          	bnez	a4,ffffffffc0204748 <proc_init+0xa2>
ffffffffc020485e:	0b07a703          	lw	a4,176(a5)
ffffffffc0204862:	8d59                	or	a0,a0,a4
ffffffffc0204864:	0005071b          	sext.w	a4,a0
ffffffffc0204868:	ee0710e3          	bnez	a4,ffffffffc0204748 <proc_init+0xa2>
        cprintf("alloc_proc() correct!\n");
ffffffffc020486c:	00002517          	auipc	a0,0x2
ffffffffc0204870:	44450513          	addi	a0,a0,1092 # ffffffffc0206cb0 <default_pmm_manager+0x1050>
ffffffffc0204874:	90dfb0ef          	jal	ra,ffffffffc0200180 <cprintf>
    idleproc->pid = 0;
ffffffffc0204878:	00093783          	ld	a5,0(s2)
ffffffffc020487c:	b5f1                	j	ffffffffc0204748 <proc_init+0xa2>
            struct proc_struct *proc = le2proc(le, hash_link);
ffffffffc020487e:	f2878793          	addi	a5,a5,-216
ffffffffc0204882:	bfb9                	j	ffffffffc02047e0 <proc_init+0x13a>
        panic("cannot alloc idleproc.\n");
ffffffffc0204884:	00002617          	auipc	a2,0x2
ffffffffc0204888:	41460613          	addi	a2,a2,1044 # ffffffffc0206c98 <default_pmm_manager+0x1038>
ffffffffc020488c:	16d00593          	li	a1,365
ffffffffc0204890:	00002517          	auipc	a0,0x2
ffffffffc0204894:	3d850513          	addi	a0,a0,984 # ffffffffc0206c68 <default_pmm_manager+0x1008>
ffffffffc0204898:	baffb0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("create init_main failed.\n");
ffffffffc020489c:	00002617          	auipc	a2,0x2
ffffffffc02048a0:	44460613          	addi	a2,a2,1092 # ffffffffc0206ce0 <default_pmm_manager+0x1080>
ffffffffc02048a4:	18d00593          	li	a1,397
ffffffffc02048a8:	00002517          	auipc	a0,0x2
ffffffffc02048ac:	3c050513          	addi	a0,a0,960 # ffffffffc0206c68 <default_pmm_manager+0x1008>
ffffffffc02048b0:	b97fb0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc02048b4:	00002697          	auipc	a3,0x2
ffffffffc02048b8:	47c68693          	addi	a3,a3,1148 # ffffffffc0206d30 <default_pmm_manager+0x10d0>
ffffffffc02048bc:	00001617          	auipc	a2,0x1
ffffffffc02048c0:	ff460613          	addi	a2,a2,-12 # ffffffffc02058b0 <commands+0x738>
ffffffffc02048c4:	19400593          	li	a1,404
ffffffffc02048c8:	00002517          	auipc	a0,0x2
ffffffffc02048cc:	3a050513          	addi	a0,a0,928 # ffffffffc0206c68 <default_pmm_manager+0x1008>
ffffffffc02048d0:	b77fb0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc02048d4:	00002697          	auipc	a3,0x2
ffffffffc02048d8:	43468693          	addi	a3,a3,1076 # ffffffffc0206d08 <default_pmm_manager+0x10a8>
ffffffffc02048dc:	00001617          	auipc	a2,0x1
ffffffffc02048e0:	fd460613          	addi	a2,a2,-44 # ffffffffc02058b0 <commands+0x738>
ffffffffc02048e4:	19300593          	li	a1,403
ffffffffc02048e8:	00002517          	auipc	a0,0x2
ffffffffc02048ec:	38050513          	addi	a0,a0,896 # ffffffffc0206c68 <default_pmm_manager+0x1008>
ffffffffc02048f0:	b57fb0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc02048f4 <cpu_idle>:

// cpu_idle - at the end of kern_init, the first kernel thread idleproc will do below works
void
cpu_idle(void) {
ffffffffc02048f4:	1141                	addi	sp,sp,-16
ffffffffc02048f6:	e022                	sd	s0,0(sp)
ffffffffc02048f8:	e406                	sd	ra,8(sp)
ffffffffc02048fa:	00011417          	auipc	s0,0x11
ffffffffc02048fe:	cb640413          	addi	s0,s0,-842 # ffffffffc02155b0 <current>
    while (1) {
        if (current->need_resched) {
ffffffffc0204902:	6018                	ld	a4,0(s0)
ffffffffc0204904:	4f1c                	lw	a5,24(a4)
ffffffffc0204906:	2781                	sext.w	a5,a5
ffffffffc0204908:	dff5                	beqz	a5,ffffffffc0204904 <cpu_idle+0x10>
            schedule();
ffffffffc020490a:	0a2000ef          	jal	ra,ffffffffc02049ac <schedule>
ffffffffc020490e:	bfd5                	j	ffffffffc0204902 <cpu_idle+0xe>

ffffffffc0204910 <switch_to>:
.text
...
ffffffffc0204910:	00153023          	sd	ra,0(a0)
    STORE sp, 1*REGBYTES(a0)
ffffffffc0204914:	00253423          	sd	sp,8(a0)
    STORE s0, 2*REGBYTES(a0)
ffffffffc0204918:	e900                	sd	s0,16(a0)
    STORE s1, 3*REGBYTES(a0)
ffffffffc020491a:	ed04                	sd	s1,24(a0)
    STORE s2, 4*REGBYTES(a0)
ffffffffc020491c:	03253023          	sd	s2,32(a0)
    STORE s3, 5*REGBYTES(a0)
ffffffffc0204920:	03353423          	sd	s3,40(a0)
    STORE s4, 6*REGBYTES(a0)
ffffffffc0204924:	03453823          	sd	s4,48(a0)
    STORE s5, 7*REGBYTES(a0)
ffffffffc0204928:	03553c23          	sd	s5,56(a0)
    STORE s6, 8*REGBYTES(a0)
ffffffffc020492c:	05653023          	sd	s6,64(a0)
    STORE s7, 9*REGBYTES(a0)
ffffffffc0204930:	05753423          	sd	s7,72(a0)
    STORE s8, 10*REGBYTES(a0)
ffffffffc0204934:	05853823          	sd	s8,80(a0)
    STORE s9, 11*REGBYTES(a0)
ffffffffc0204938:	05953c23          	sd	s9,88(a0)
    STORE s10, 12*REGBYTES(a0)
ffffffffc020493c:	07a53023          	sd	s10,96(a0)
    STORE s11, 13*REGBYTES(a0)
ffffffffc0204940:	07b53423          	sd	s11,104(a0)

    # restore to's registers
    LOAD ra, 0*REGBYTES(a1)
ffffffffc0204944:	0005b083          	ld	ra,0(a1)
    LOAD sp, 1*REGBYTES(a1)
ffffffffc0204948:	0085b103          	ld	sp,8(a1)
    LOAD s0, 2*REGBYTES(a1)
ffffffffc020494c:	6980                	ld	s0,16(a1)
    LOAD s1, 3*REGBYTES(a1)
ffffffffc020494e:	6d84                	ld	s1,24(a1)
    LOAD s2, 4*REGBYTES(a1)
ffffffffc0204950:	0205b903          	ld	s2,32(a1)
    LOAD s3, 5*REGBYTES(a1)
ffffffffc0204954:	0285b983          	ld	s3,40(a1)
    LOAD s4, 6*REGBYTES(a1)
ffffffffc0204958:	0305ba03          	ld	s4,48(a1)
    LOAD s5, 7*REGBYTES(a1)
ffffffffc020495c:	0385ba83          	ld	s5,56(a1)
    LOAD s6, 8*REGBYTES(a1)
ffffffffc0204960:	0405bb03          	ld	s6,64(a1)
    LOAD s7, 9*REGBYTES(a1)
ffffffffc0204964:	0485bb83          	ld	s7,72(a1)
    LOAD s8, 10*REGBYTES(a1)
ffffffffc0204968:	0505bc03          	ld	s8,80(a1)
    LOAD s9, 11*REGBYTES(a1)
ffffffffc020496c:	0585bc83          	ld	s9,88(a1)
    LOAD s10, 12*REGBYTES(a1)
ffffffffc0204970:	0605bd03          	ld	s10,96(a1)
    LOAD s11, 13*REGBYTES(a1)
ffffffffc0204974:	0685bd83          	ld	s11,104(a1)

    ret
ffffffffc0204978:	8082                	ret

ffffffffc020497a <wakeup_proc>:
#include <assert.h>
...
ffffffffc020497a:	411c                	lw	a5,0(a0)
ffffffffc020497c:	4705                	li	a4,1
ffffffffc020497e:	37f9                	addiw	a5,a5,-2
ffffffffc0204980:	00f77563          	bgeu	a4,a5,ffffffffc020498a <wakeup_proc+0x10>
    proc->state = PROC_RUNNABLE;
ffffffffc0204984:	4789                	li	a5,2
ffffffffc0204986:	c11c                	sw	a5,0(a0)
ffffffffc0204988:	8082                	ret
{
ffffffffc020498a:	1141                	addi	sp,sp,-16
    assert(proc->state != PROC_ZOMBIE && proc->state != PROC_RUNNABLE);
ffffffffc020498c:	00002697          	auipc	a3,0x2
ffffffffc0204990:	3cc68693          	addi	a3,a3,972 # ffffffffc0206d58 <default_pmm_manager+0x10f8>
ffffffffc0204994:	00001617          	auipc	a2,0x1
ffffffffc0204998:	f1c60613          	addi	a2,a2,-228 # ffffffffc02058b0 <commands+0x738>
ffffffffc020499c:	45a9                	li	a1,10
ffffffffc020499e:	00002517          	auipc	a0,0x2
ffffffffc02049a2:	3fa50513          	addi	a0,a0,1018 # ffffffffc0206d98 <default_pmm_manager+0x1138>
{
ffffffffc02049a6:	e406                	sd	ra,8(sp)
    assert(proc->state != PROC_ZOMBIE && proc->state != PROC_RUNNABLE);
ffffffffc02049a8:	a9ffb0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc02049ac <schedule>:
}
...
ffffffffc02049b0:	e022                	sd	s0,0(sp)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc02049b2:	100027f3          	csrr	a5,sstatus
ffffffffc02049b6:	8b89                	andi	a5,a5,2
ffffffffc02049b8:	4401                	li	s0,0
ffffffffc02049ba:	efbd                	bnez	a5,ffffffffc0204a38 <schedule+0x8c>
    bool intr_flag;
...
ffffffffc02049bc:	00011897          	auipc	a7,0x11
ffffffffc02049c0:	bf48b883          	ld	a7,-1036(a7) # ffffffffc02155b0 <current>
ffffffffc02049c4:	0008ac23          	sw	zero,24(a7)
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc02049c8:	00011517          	auipc	a0,0x11
ffffffffc02049cc:	bf053503          	ld	a0,-1040(a0) # ffffffffc02155b8 <idleproc>
ffffffffc02049d0:	04a88e63          	beq	a7,a0,ffffffffc0204a2c <schedule+0x80>
ffffffffc02049d4:	0c888693          	addi	a3,a7,200
ffffffffc02049d8:	00011617          	auipc	a2,0x11
ffffffffc02049dc:	b5060613          	addi	a2,a2,-1200 # ffffffffc0215528 <proc_list>
        le = last;
ffffffffc02049e0:	87b6                	mv	a5,a3
    struct proc_struct *next = NULL;
...
ffffffffc02049e4:	4809                	li	a6,2
ffffffffc02049e6:	679c                	ld	a5,8(a5)
            if ((le = list_next(le)) != &proc_list) {
ffffffffc02049e8:	00c78863          	beq	a5,a2,ffffffffc02049f8 <schedule+0x4c>
                if (next->state == PROC_RUNNABLE) {
ffffffffc02049ec:	f387a703          	lw	a4,-200(a5)
                next = le2proc(le, list_link);
ffffffffc02049f0:	f3878593          	addi	a1,a5,-200
                if (next->state == PROC_RUNNABLE) {
ffffffffc02049f4:	03070163          	beq	a4,a6,ffffffffc0204a16 <schedule+0x6a>
                    break;
                }
            }
        } while (le != last);
ffffffffc02049f8:	fef697e3          	bne	a3,a5,ffffffffc02049e6 <schedule+0x3a>
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc02049fc:	ed89                	bnez	a1,ffffffffc0204a16 <schedule+0x6a>
            next = idleproc;
        }
        next->runs ++;
ffffffffc02049fe:	451c                	lw	a5,8(a0)
ffffffffc0204a00:	2785                	addiw	a5,a5,1
ffffffffc0204a02:	c51c                	sw	a5,8(a0)
        if (next != current) {
ffffffffc0204a04:	00a88463          	beq	a7,a0,ffffffffc0204a0c <schedule+0x60>
            proc_run(next);
ffffffffc0204a08:	8f5ff0ef          	jal	ra,ffffffffc02042fc <proc_run>
    if (flag) {
ffffffffc0204a0c:	e819                	bnez	s0,ffffffffc0204a22 <schedule+0x76>
        }
    }
    local_intr_restore(intr_flag);
}
ffffffffc0204a0e:	60a2                	ld	ra,8(sp)
ffffffffc0204a10:	6402                	ld	s0,0(sp)
ffffffffc0204a12:	0141                	addi	sp,sp,16
ffffffffc0204a14:	8082                	ret
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc0204a16:	4198                	lw	a4,0(a1)
ffffffffc0204a18:	4789                	li	a5,2
ffffffffc0204a1a:	fef712e3          	bne	a4,a5,ffffffffc02049fe <schedule+0x52>
ffffffffc0204a1e:	852e                	mv	a0,a1
ffffffffc0204a20:	bff9                	j	ffffffffc02049fe <schedule+0x52>
}
ffffffffc0204a22:	6402                	ld	s0,0(sp)
ffffffffc0204a24:	60a2                	ld	ra,8(sp)
ffffffffc0204a26:	0141                	addi	sp,sp,16
        intr_enable();
ffffffffc0204a28:	b95fb06f          	j	ffffffffc02005bc <intr_enable>
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc0204a2c:	00011617          	auipc	a2,0x11
ffffffffc0204a30:	afc60613          	addi	a2,a2,-1284 # ffffffffc0215528 <proc_list>
ffffffffc0204a34:	86b2                	mv	a3,a2
ffffffffc0204a36:	b76d                	j	ffffffffc02049e0 <schedule+0x34>
        intr_disable();
ffffffffc0204a38:	b8bfb0ef          	jal	ra,ffffffffc02005c2 <intr_disable>
        return 1;
ffffffffc0204a3c:	4405                	li	s0,1
ffffffffc0204a3e:	bfbd                	j	ffffffffc02049bc <schedule+0x10>

ffffffffc0204a40 <hash32>:
 *
...
ffffffffc0204a40:	9e3707b7          	lui	a5,0x9e370
ffffffffc0204a44:	2785                	addiw	a5,a5,1
ffffffffc0204a46:	02a7853b          	mulw	a0,a5,a0
    return (hash >> (32 - bits));
ffffffffc0204a4a:	02000793          	li	a5,32
ffffffffc0204a4e:	9f8d                	subw	a5,a5,a1
}
ffffffffc0204a50:	00f5553b          	srlw	a0,a0,a5
ffffffffc0204a54:	8082                	ret

ffffffffc0204a56 <printnum>:
 * */
static void
...
ffffffffc0204a56:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0204a5a:	7179                	addi	sp,sp,-48
    unsigned mod = do_div(result, base);
ffffffffc0204a5c:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0204a60:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
ffffffffc0204a62:	03067a33          	remu	s4,a2,a6
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0204a66:	f022                	sd	s0,32(sp)
ffffffffc0204a68:	ec26                	sd	s1,24(sp)
ffffffffc0204a6a:	e84a                	sd	s2,16(sp)
ffffffffc0204a6c:	f406                	sd	ra,40(sp)
ffffffffc0204a6e:	e44e                	sd	s3,8(sp)
ffffffffc0204a70:	84aa                	mv	s1,a0
ffffffffc0204a72:	892e                	mv	s2,a1
    ...
    if (num >= base) {
        ...
        while (-- width > 0)
ffffffffc0204a74:	fff7041b          	addiw	s0,a4,-1
    unsigned mod = do_div(result, base);
ffffffffc0204a78:	2a01                	sext.w	s4,s4
    if (num >= base) {
ffffffffc0204a7a:	03067e63          	bgeu	a2,a6,ffffffffc0204ab6 <printnum+0x60>
ffffffffc0204a7e:	89be                	mv	s3,a5
        while (-- width > 0)
ffffffffc0204a80:	00805763          	blez	s0,ffffffffc0204a8e <printnum+0x38>
ffffffffc0204a84:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
ffffffffc0204a86:	85ca                	mv	a1,s2
ffffffffc0204a88:	854e                	mv	a0,s3
ffffffffc0204a8a:	9482                	jalr	s1
        while (-- width > 0)
ffffffffc0204a8c:	fc65                	bnez	s0,ffffffffc0204a84 <printnum+0x2e>
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204a8e:	1a02                	slli	s4,s4,0x20
ffffffffc0204a90:	00002797          	auipc	a5,0x2
ffffffffc0204a94:	32078793          	addi	a5,a5,800 # ffffffffc0206db0 <default_pmm_manager+0x1150>
ffffffffc0204a98:	020a5a13          	srli	s4,s4,0x20
ffffffffc0204a9c:	9a3e                	add	s4,s4,a5
}
ffffffffc0204a9e:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204aa0:	000a4503          	lbu	a0,0(s4)
}
ffffffffc0204aa4:	70a2                	ld	ra,40(sp)
ffffffffc0204aa6:	69a2                	ld	s3,8(sp)
ffffffffc0204aa8:	6a02                	ld	s4,0(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204aaa:	85ca                	mv	a1,s2
ffffffffc0204aac:	87a6                	mv	a5,s1
}
ffffffffc0204aae:	6942                	ld	s2,16(sp)
ffffffffc0204ab0:	64e2                	ld	s1,24(sp)
ffffffffc0204ab2:	6145                	addi	sp,sp,48
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204ab4:	8782                	jr	a5
        printnum(putch, putdat, result, base, width - 1, padc);
ffffffffc0204ab6:	03065633          	divu	a2,a2,a6
ffffffffc0204aba:	8722                	mv	a4,s0
ffffffffc0204abc:	f9bff0ef          	jal	ra,ffffffffc0204a56 <printnum>
ffffffffc0204ac0:	b7f9                	j	ffffffffc0204a8e <printnum+0x38>

ffffffffc0204ac2 <vprintfmt>:
 *
 * Call this function if you are already dealing with a va_list.
...
ffffffffc0204ac2:	7119                	addi	sp,sp,-128
ffffffffc0204ac4:	f4a6                	sd	s1,104(sp)
ffffffffc0204ac6:	f0ca                	sd	s2,96(sp)
ffffffffc0204ac8:	ecce                	sd	s3,88(sp)
ffffffffc0204aca:	e8d2                	sd	s4,80(sp)
ffffffffc0204acc:	e4d6                	sd	s5,72(sp)
ffffffffc0204ace:	e0da                	sd	s6,64(sp)
ffffffffc0204ad0:	fc5e                	sd	s7,56(sp)
ffffffffc0204ad2:	f06a                	sd	s10,32(sp)
ffffffffc0204ad4:	fc86                	sd	ra,120(sp)
ffffffffc0204ad6:	f8a2                	sd	s0,112(sp)
ffffffffc0204ad8:	f862                	sd	s8,48(sp)
ffffffffc0204ada:	f466                	sd	s9,40(sp)
ffffffffc0204adc:	ec6e                	sd	s11,24(sp)
ffffffffc0204ade:	892a                	mv	s2,a0
ffffffffc0204ae0:	84ae                	mv	s1,a1
ffffffffc0204ae2:	8d32                	mv	s10,a2
ffffffffc0204ae4:	8a36                	mv	s4,a3
    register int ch, err;
...
ffffffffc0204ae6:	02500993          	li	s3,37
        ...
        char padc = ' ';
        width = precision = -1;
ffffffffc0204aea:	5b7d                	li	s6,-1
ffffffffc0204aec:	00002a97          	auipc	s5,0x2
ffffffffc0204af0:	2f0a8a93          	addi	s5,s5,752 # ffffffffc0206ddc <default_pmm_manager+0x117c>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
...
ffffffffc0204af4:	00002b97          	auipc	s7,0x2
ffffffffc0204af8:	4c4b8b93          	addi	s7,s7,1220 # ffffffffc0206fb8 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204afc:	000d4503          	lbu	a0,0(s10)
ffffffffc0204b00:	001d0413          	addi	s0,s10,1
ffffffffc0204b04:	01350a63          	beq	a0,s3,ffffffffc0204b18 <vprintfmt+0x56>
            if (ch == '\0') {
ffffffffc0204b08:	c121                	beqz	a0,ffffffffc0204b48 <vprintfmt+0x86>
            putch(ch, putdat);
...
ffffffffc0204b14:	ff351ae3          	bne	a0,s3,ffffffffc0204b08 <vprintfmt+0x46>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204b18:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc0204b1c:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc0204b20:	4c81                	li	s9,0
ffffffffc0204b22:	4881                	li	a7,0
        width = precision = -1;
ffffffffc0204b24:	5c7d                	li	s8,-1
ffffffffc0204b26:	5dfd                	li	s11,-1
ffffffffc0204b28:	05500513          	li	a0,85
                if (ch < '0' || ch > '9') {
ffffffffc0204b2c:	4825                	li	a6,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204b2e:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0204b32:	0ff5f593          	zext.b	a1,a1
ffffffffc0204b36:	00140d13          	addi	s10,s0,1
ffffffffc0204b3a:	04b56263          	bltu	a0,a1,ffffffffc0204b7e <vprintfmt+0xbc>
ffffffffc0204b3e:	058a                	slli	a1,a1,0x2
ffffffffc0204b40:	95d6                	add	a1,a1,s5
ffffffffc0204b42:	4194                	lw	a3,0(a1)
ffffffffc0204b44:	96d6                	add	a3,a3,s5
...
ffffffffc0204b64:	8082                	ret
            padc = '0';
ffffffffc0204b66:	87b2                	mv	a5,a2
            goto reswitch;
ffffffffc0204b68:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204b6c:	846a                	mv	s0,s10
ffffffffc0204b6e:	00140d13          	addi	s10,s0,1
ffffffffc0204b72:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0204b76:	0ff5f593          	zext.b	a1,a1
ffffffffc0204b7a:	fcb572e3          	bgeu	a0,a1,ffffffffc0204b3e <vprintfmt+0x7c>
            putch('%', putdat);
ffffffffc0204b7e:	85a6                	mv	a1,s1
ffffffffc0204b80:	02500513          	li	a0,37
ffffffffc0204b84:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc0204b86:	fff44783          	lbu	a5,-1(s0)
ffffffffc0204b8a:	8d22                	mv	s10,s0
ffffffffc0204b8c:	f73788e3          	beq	a5,s3,ffffffffc0204afc <vprintfmt+0x3a>
ffffffffc0204b90:	ffed4783          	lbu	a5,-2(s10)
ffffffffc0204b94:	1d7d                	addi	s10,s10,-1
ffffffffc0204b96:	ff379de3          	bne	a5,s3,ffffffffc0204b90 <vprintfmt+0xce>
ffffffffc0204b9a:	b78d                	j	ffffffffc0204afc <vprintfmt+0x3a>
                precision = precision * 10 + ch - '0';
ffffffffc0204b9c:	fd060c1b          	addiw	s8,a2,-48
                ch = *fmt;
ffffffffc0204ba0:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204ba4:	846a                	mv	s0,s10
                if (ch < '0' || ch > '9') {
ffffffffc0204ba6:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc0204baa:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0204bae:	02d86463          	bltu	a6,a3,ffffffffc0204bd6 <vprintfmt+0x114>
                ch = *fmt;
ffffffffc0204bb2:	00144603          	lbu	a2,1(s0)
                precision = precision * 10 + ch - '0';
ffffffffc0204bb6:	002c169b          	slliw	a3,s8,0x2
ffffffffc0204bba:	0186873b          	addw	a4,a3,s8
ffffffffc0204bbe:	0017171b          	slliw	a4,a4,0x1
ffffffffc0204bc2:	9f2d                	addw	a4,a4,a1
                if (ch < '0' || ch > '9') {
ffffffffc0204bc4:	fd06069b          	addiw	a3,a2,-48
            for (precision = 0; ; ++ fmt) {
ffffffffc0204bc8:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc0204bca:	fd070c1b          	addiw	s8,a4,-48
                ch = *fmt;
ffffffffc0204bce:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0204bd2:	fed870e3          	bgeu	a6,a3,ffffffffc0204bb2 <vprintfmt+0xf0>
            if (width < 0)
ffffffffc0204bd6:	f40ddce3          	bgez	s11,ffffffffc0204b2e <vprintfmt+0x6c>
                width = precision, precision = -1;
ffffffffc0204bda:	8de2                	mv	s11,s8
ffffffffc0204bdc:	5c7d                	li	s8,-1
ffffffffc0204bde:	bf81                	j	ffffffffc0204b2e <vprintfmt+0x6c>
            if (width < 0)
...
ffffffffc0204bf0:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204bf2:	bf35                	j	ffffffffc0204b2e <vprintfmt+0x6c>
            precision = va_arg(ap, int);
ffffffffc0204bf4:	000a2c03          	lw	s8,0(s4)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204bf8:	00144603          	lbu	a2,1(s0)
            precision = va_arg(ap, int);
ffffffffc0204bfc:	0a21                	addi	s4,s4,8
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204bfe:	846a                	mv	s0,s10
            goto process_precision;
ffffffffc0204c00:	bfd9                	j	ffffffffc0204bd6 <vprintfmt+0x114>
    if (lflag >= 2) {
ffffffffc0204c02:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204c04:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204c08:	01174463          	blt	a4,a7,ffffffffc0204c10 <vprintfmt+0x14e>
    else if (lflag) {
ffffffffc0204c0c:	1a088e63          	beqz	a7,ffffffffc0204dc8 <vprintfmt+0x306>
        return va_arg(*ap, unsigned long);
ffffffffc0204c10:	000a3603          	ld	a2,0(s4)
ffffffffc0204c14:	46c1                	li	a3,16
ffffffffc0204c16:	8a2e                	mv	s4,a1
            printnum(putch, putdat, num, base, width, padc);
ffffffffc0204c18:	2781                	sext.w	a5,a5
ffffffffc0204c1a:	876e                	mv	a4,s11
ffffffffc0204c1c:	85a6                	mv	a1,s1
ffffffffc0204c1e:	854a                	mv	a0,s2
ffffffffc0204c20:	e37ff0ef          	jal	ra,ffffffffc0204a56 <printnum>
            break;
ffffffffc0204c24:	bde1                	j	ffffffffc0204afc <vprintfmt+0x3a>
            putch(va_arg(ap, int), putdat);
ffffffffc0204c26:	000a2503          	lw	a0,0(s4)
ffffffffc0204c2a:	85a6                	mv	a1,s1
ffffffffc0204c2c:	0a21                	addi	s4,s4,8
ffffffffc0204c2e:	9902                	jalr	s2
            break;
ffffffffc0204c30:	b5f1                	j	ffffffffc0204afc <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204c32:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204c34:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204c38:	01174463          	blt	a4,a7,ffffffffc0204c40 <vprintfmt+0x17e>
    else if (lflag) {
ffffffffc0204c3c:	18088163          	beqz	a7,ffffffffc0204dbe <vprintfmt+0x2fc>
        return va_arg(*ap, unsigned long);
ffffffffc0204c40:	000a3603          	ld	a2,0(s4)
ffffffffc0204c44:	46a9                	li	a3,10
ffffffffc0204c46:	8a2e                	mv	s4,a1
ffffffffc0204c48:	bfc1                	j	ffffffffc0204c18 <vprintfmt+0x156>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c4a:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc0204c4e:	4c85                	li	s9,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c50:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204c52:	bdf1                	j	ffffffffc0204b2e <vprintfmt+0x6c>
            putch(ch, putdat);
ffffffffc0204c54:	85a6                	mv	a1,s1
ffffffffc0204c56:	02500513          	li	a0,37
ffffffffc0204c5a:	9902                	jalr	s2
            break;
ffffffffc0204c5c:	b545                	j	ffffffffc0204afc <vprintfmt+0x3a>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c5e:	00144603          	lbu	a2,1(s0)
            lflag ++;
ffffffffc0204c62:	2885                	addiw	a7,a7,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c64:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204c66:	b5e1                	j	ffffffffc0204b2e <vprintfmt+0x6c>
    if (lflag >= 2) {
ffffffffc0204c68:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204c6a:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204c6e:	01174463          	blt	a4,a7,ffffffffc0204c76 <vprintfmt+0x1b4>
    else if (lflag) {
ffffffffc0204c72:	14088163          	beqz	a7,ffffffffc0204db4 <vprintfmt+0x2f2>
        return va_arg(*ap, unsigned long);
ffffffffc0204c76:	000a3603          	ld	a2,0(s4)
ffffffffc0204c7a:	46a1                	li	a3,8
ffffffffc0204c7c:	8a2e                	mv	s4,a1
ffffffffc0204c7e:	bf69                	j	ffffffffc0204c18 <vprintfmt+0x156>
            putch('0', putdat);
ffffffffc0204c80:	03000513          	li	a0,48
ffffffffc0204c84:	85a6                	mv	a1,s1
ffffffffc0204c86:	e03e                	sd	a5,0(sp)
ffffffffc0204c88:	9902                	jalr	s2
            putch('x', putdat);
ffffffffc0204c8a:	85a6                	mv	a1,s1
ffffffffc0204c8c:	07800513          	li	a0,120
ffffffffc0204c90:	9902                	jalr	s2
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0204c92:	0a21                	addi	s4,s4,8
            goto number;
ffffffffc0204c94:	6782                	ld	a5,0(sp)
ffffffffc0204c96:	46c1                	li	a3,16
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0204c98:	ff8a3603          	ld	a2,-8(s4)
            goto number;
ffffffffc0204c9c:	bfb5                	j	ffffffffc0204c18 <vprintfmt+0x156>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0204c9e:	000a3403          	ld	s0,0(s4)
ffffffffc0204ca2:	008a0713          	addi	a4,s4,8
ffffffffc0204ca6:	e03a                	sd	a4,0(sp)
ffffffffc0204ca8:	14040263          	beqz	s0,ffffffffc0204dec <vprintfmt+0x32a>
            if (width > 0 && padc != '-') {
ffffffffc0204cac:	0fb05763          	blez	s11,ffffffffc0204d9a <vprintfmt+0x2d8>
ffffffffc0204cb0:	02d00693          	li	a3,45
ffffffffc0204cb4:	0cd79163          	bne	a5,a3,ffffffffc0204d76 <vprintfmt+0x2b4>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204cb8:	00044783          	lbu	a5,0(s0)
ffffffffc0204cbc:	0007851b          	sext.w	a0,a5
ffffffffc0204cc0:	cf85                	beqz	a5,ffffffffc0204cf8 <vprintfmt+0x236>
ffffffffc0204cc2:	00140a13          	addi	s4,s0,1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204cc6:	05e00413          	li	s0,94
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204cca:	000c4563          	bltz	s8,ffffffffc0204cd4 <vprintfmt+0x212>
ffffffffc0204cce:	3c7d                	addiw	s8,s8,-1
ffffffffc0204cd0:	036c0263          	beq	s8,s6,ffffffffc0204cf4 <vprintfmt+0x232>
                    putch('?', putdat);
ffffffffc0204cd4:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204cd6:	0e0c8e63          	beqz	s9,ffffffffc0204dd2 <vprintfmt+0x310>
ffffffffc0204cda:	3781                	addiw	a5,a5,-32
ffffffffc0204cdc:	0ef47b63          	bgeu	s0,a5,ffffffffc0204dd2 <vprintfmt+0x310>
                    putch('?', putdat);
ffffffffc0204ce0:	03f00513          	li	a0,63
ffffffffc0204ce4:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204ce6:	000a4783          	lbu	a5,0(s4)
ffffffffc0204cea:	3dfd                	addiw	s11,s11,-1
ffffffffc0204cec:	0a05                	addi	s4,s4,1
ffffffffc0204cee:	0007851b          	sext.w	a0,a5
ffffffffc0204cf2:	ffe1                	bnez	a5,ffffffffc0204cca <vprintfmt+0x208>
            for (; width > 0; width --) {
ffffffffc0204cf4:	01b05963          	blez	s11,ffffffffc0204d06 <vprintfmt+0x244>
...
ffffffffc0204d00:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc0204d02:	fe0d9be3          	bnez	s11,ffffffffc0204cf8 <vprintfmt+0x236>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0204d06:	6a02                	ld	s4,0(sp)
ffffffffc0204d08:	bbd5                	j	ffffffffc0204afc <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204d0a:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204d0c:	008a0c93          	addi	s9,s4,8
    if (lflag >= 2) {
ffffffffc0204d10:	01174463          	blt	a4,a7,ffffffffc0204d18 <vprintfmt+0x256>
    else if (lflag) {
ffffffffc0204d14:	08088d63          	beqz	a7,ffffffffc0204dae <vprintfmt+0x2ec>
        return va_arg(*ap, long);
ffffffffc0204d18:	000a3403          	ld	s0,0(s4)
            if ((long long)num < 0) {
ffffffffc0204d1c:	0a044d63          	bltz	s0,ffffffffc0204dd6 <vprintfmt+0x314>
            num = getint(&ap, lflag);
ffffffffc0204d20:	8622                	mv	a2,s0
ffffffffc0204d22:	8a66                	mv	s4,s9
ffffffffc0204d24:	46a9                	li	a3,10
ffffffffc0204d26:	bdcd                	j	ffffffffc0204c18 <vprintfmt+0x156>
            err = va_arg(ap, int);
ffffffffc0204d28:	000a2783          	lw	a5,0(s4)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204d2c:	4719                	li	a4,6
            err = va_arg(ap, int);
ffffffffc0204d2e:	0a21                	addi	s4,s4,8
            if (err < 0) {
ffffffffc0204d30:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc0204d34:	8fb5                	xor	a5,a5,a3
ffffffffc0204d36:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204d3a:	02d74163          	blt	a4,a3,ffffffffc0204d5c <vprintfmt+0x29a>
ffffffffc0204d3e:	00369793          	slli	a5,a3,0x3
ffffffffc0204d42:	97de                	add	a5,a5,s7
ffffffffc0204d44:	639c                	ld	a5,0(a5)
ffffffffc0204d46:	cb99                	beqz	a5,ffffffffc0204d5c <vprintfmt+0x29a>
                printfmt(putch, putdat, "%s", p);
ffffffffc0204d48:	86be                	mv	a3,a5
ffffffffc0204d4a:	00000617          	auipc	a2,0x0
ffffffffc0204d4e:	1ee60613          	addi	a2,a2,494 # ffffffffc0204f38 <etext+0x2a>
ffffffffc0204d52:	85a6                	mv	a1,s1
ffffffffc0204d54:	854a                	mv	a0,s2
ffffffffc0204d56:	0ce000ef          	jal	ra,ffffffffc0204e24 <printfmt>
ffffffffc0204d5a:	b34d                	j	ffffffffc0204afc <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc0204d5c:	00002617          	auipc	a2,0x2
ffffffffc0204d60:	07460613          	addi	a2,a2,116 # ffffffffc0206dd0 <default_pmm_manager+0x1170>
ffffffffc0204d64:	85a6                	mv	a1,s1
ffffffffc0204d66:	854a                	mv	a0,s2
ffffffffc0204d68:	0bc000ef          	jal	ra,ffffffffc0204e24 <printfmt>
ffffffffc0204d6c:	bb41                	j	ffffffffc0204afc <vprintfmt+0x3a>
                p = "(null)";
ffffffffc0204d6e:	00002417          	auipc	s0,0x2
ffffffffc0204d72:	05a40413          	addi	s0,s0,90 # ffffffffc0206dc8 <default_pmm_manager+0x1168>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204d76:	85e2                	mv	a1,s8
ffffffffc0204d78:	8522                	mv	a0,s0
ffffffffc0204d7a:	e43e                	sd	a5,8(sp)
ffffffffc0204d7c:	0e2000ef          	jal	ra,ffffffffc0204e5e <strnlen>
ffffffffc0204d80:	40ad8dbb          	subw	s11,s11,a0
ffffffffc0204d84:	01b05b63          	blez	s11,ffffffffc0204d9a <vprintfmt+0x2d8>
                    putch(padc, putdat);
ffffffffc0204d88:	67a2                	ld	a5,8(sp)
ffffffffc0204d8a:	00078a1b          	sext.w	s4,a5
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204d8e:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
ffffffffc0204d90:	85a6                	mv	a1,s1
ffffffffc0204d92:	8552                	mv	a0,s4
ffffffffc0204d94:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204d96:	fe0d9ce3          	bnez	s11,ffffffffc0204d8e <vprintfmt+0x2cc>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204d9a:	00044783          	lbu	a5,0(s0)
ffffffffc0204d9e:	00140a13          	addi	s4,s0,1
ffffffffc0204da2:	0007851b          	sext.w	a0,a5
ffffffffc0204da6:	d3a5                	beqz	a5,ffffffffc0204d06 <vprintfmt+0x244>
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204da8:	05e00413          	li	s0,94
ffffffffc0204dac:	bf39                	j	ffffffffc0204cca <vprintfmt+0x208>
        return va_arg(*ap, int);
ffffffffc0204dae:	000a2403          	lw	s0,0(s4)
ffffffffc0204db2:	b7ad                	j	ffffffffc0204d1c <vprintfmt+0x25a>
        return va_arg(*ap, unsigned int);
ffffffffc0204db4:	000a6603          	lwu	a2,0(s4)
ffffffffc0204db8:	46a1                	li	a3,8
ffffffffc0204dba:	8a2e                	mv	s4,a1
ffffffffc0204dbc:	bdb1                	j	ffffffffc0204c18 <vprintfmt+0x156>
ffffffffc0204dbe:	000a6603          	lwu	a2,0(s4)
ffffffffc0204dc2:	46a9                	li	a3,10
ffffffffc0204dc4:	8a2e                	mv	s4,a1
ffffffffc0204dc6:	bd89                	j	ffffffffc0204c18 <vprintfmt+0x156>
ffffffffc0204dc8:	000a6603          	lwu	a2,0(s4)
ffffffffc0204dcc:	46c1                	li	a3,16
ffffffffc0204dce:	8a2e                	mv	s4,a1
ffffffffc0204dd0:	b5a1                	j	ffffffffc0204c18 <vprintfmt+0x156>
                    putch(ch, putdat);
ffffffffc0204dd2:	9902                	jalr	s2
ffffffffc0204dd4:	bf09                	j	ffffffffc0204ce6 <vprintfmt+0x224>
                putch('-', putdat);
ffffffffc0204dd6:	85a6                	mv	a1,s1
ffffffffc0204dd8:	02d00513          	li	a0,45
ffffffffc0204ddc:	e03e                	sd	a5,0(sp)
ffffffffc0204dde:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc0204de0:	6782                	ld	a5,0(sp)
ffffffffc0204de2:	8a66                	mv	s4,s9
ffffffffc0204de4:	40800633          	neg	a2,s0
ffffffffc0204de8:	46a9                	li	a3,10
ffffffffc0204dea:	b53d                	j	ffffffffc0204c18 <vprintfmt+0x156>
            if (width > 0 && padc != '-') {
ffffffffc0204dec:	03b05163          	blez	s11,ffffffffc0204e0e <vprintfmt+0x34c>
ffffffffc0204df0:	02d00693          	li	a3,45
ffffffffc0204df4:	f6d79de3          	bne	a5,a3,ffffffffc0204d6e <vprintfmt+0x2ac>
                p = "(null)";
ffffffffc0204df8:	00002417          	auipc	s0,0x2
ffffffffc0204dfc:	fd040413          	addi	s0,s0,-48 # ffffffffc0206dc8 <default_pmm_manager+0x1168>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204e00:	02800793          	li	a5,40
ffffffffc0204e04:	02800513          	li	a0,40
ffffffffc0204e08:	00140a13          	addi	s4,s0,1
ffffffffc0204e0c:	bd6d                	j	ffffffffc0204cc6 <vprintfmt+0x204>
ffffffffc0204e0e:	00002a17          	auipc	s4,0x2
ffffffffc0204e12:	fbba0a13          	addi	s4,s4,-69 # ffffffffc0206dc9 <default_pmm_manager+0x1169>
ffffffffc0204e16:	02800513          	li	a0,40
ffffffffc0204e1a:	02800793          	li	a5,40
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204e1e:	05e00413          	li	s0,94
ffffffffc0204e22:	b565                	j	ffffffffc0204cca <vprintfmt+0x208>

ffffffffc0204e24 <printfmt>:
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204e24:	715d                	addi	sp,sp,-80
    va_start(ap, fmt);
ffffffffc0204e26:	02810313          	addi	t1,sp,40
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204e2a:	f436                	sd	a3,40(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0204e2c:	869a                	mv	a3,t1
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204e2e:	ec06                	sd	ra,24(sp)
ffffffffc0204e30:	f83a                	sd	a4,48(sp)
ffffffffc0204e32:	fc3e                	sd	a5,56(sp)
ffffffffc0204e34:	e0c2                	sd	a6,64(sp)
ffffffffc0204e36:	e4c6                	sd	a7,72(sp)
    va_start(ap, fmt);
ffffffffc0204e38:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0204e3a:	c89ff0ef          	jal	ra,ffffffffc0204ac2 <vprintfmt>
}
ffffffffc0204e3e:	60e2                	ld	ra,24(sp)
ffffffffc0204e40:	6161                	addi	sp,sp,80
ffffffffc0204e42:	8082                	ret

ffffffffc0204e44 <strlen>:
...
strlen(const char *s) {
ffffffffc0204e48:	872a                	mv	a4,a0
    size_t cnt = 0;
ffffffffc0204e4a:	4501                	li	a0,0
    while (*s ++ != '\0') {
ffffffffc0204e4c:	cb81                	beqz	a5,ffffffffc0204e5c <strlen+0x18>
        cnt ++;
ffffffffc0204e4e:	0505                	addi	a0,a0,1
    while (*s ++ != '\0') {
ffffffffc0204e50:	00a707b3          	add	a5,a4,a0
ffffffffc0204e54:	0007c783          	lbu	a5,0(a5)
ffffffffc0204e58:	fbfd                	bnez	a5,ffffffffc0204e4e <strlen+0xa>
...
ffffffffc0204e5e:	4781                	li	a5,0
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204e60:	e589                	bnez	a1,ffffffffc0204e6a <strnlen+0xc>
ffffffffc0204e62:	a811                	j	ffffffffc0204e76 <strnlen+0x18>
        cnt ++;
ffffffffc0204e64:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204e66:	00f58863          	beq	a1,a5,ffffffffc0204e76 <strnlen+0x18>
ffffffffc0204e6a:	00f50733          	add	a4,a0,a5
ffffffffc0204e6e:	00074703          	lbu	a4,0(a4)
ffffffffc0204e72:	fb6d                	bnez	a4,ffffffffc0204e64 <strnlen+0x6>
ffffffffc0204e74:	85be                	mv	a1,a5
    }
    return cnt;
}
ffffffffc0204e76:	852e                	mv	a0,a1
ffffffffc0204e78:	8082                	ret

ffffffffc0204e7a <strcpy>:
char *
...
ffffffffc0204e88:	fb75                	bnez	a4,ffffffffc0204e7c <strcpy+0x2>
        /* nothing */;
    return dst;
...
ffffffffc0204e90:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204e94:	cb89                	beqz	a5,ffffffffc0204ea6 <strcmp+0x1a>
        s1 ++, s2 ++;
ffffffffc0204e96:	0505                	addi	a0,a0,1
ffffffffc0204e98:	0585                	addi	a1,a1,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204e9a:	fee789e3          	beq	a5,a4,ffffffffc0204e8c <strcmp>
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
...
ffffffffc0204ea8:	bfed                	j	ffffffffc0204ea2 <strcmp+0x16>

ffffffffc0204eaa <strchr>:
...
ffffffffc0204eae:	c799                	beqz	a5,ffffffffc0204ebc <strchr+0x12>
        if (*s == c) {
ffffffffc0204eb0:	00f58763          	beq	a1,a5,ffffffffc0204ebe <strchr+0x14>
    while (*s != '\0') {
ffffffffc0204eb4:	00154783          	lbu	a5,1(a0)
            return (char *)s;
        }
        s ++;
ffffffffc0204eb8:	0505                	addi	a0,a0,1
    while (*s != '\0') {
ffffffffc0204eba:	fbfd                	bnez	a5,ffffffffc0204eb0 <strchr+0x6>
    }
    return NULL;
...
memset(void *s, char c, size_t n) {
    ...
    char *p = s;
    while (n -- > 0) {
ffffffffc0204ec0:	ca01                	beqz	a2,ffffffffc0204ed0 <memset+0x10>
ffffffffc0204ec2:	962a                	add	a2,a2,a0
    char *p = s;
ffffffffc0204ec4:	87aa                	mv	a5,a0
        *p ++ = c;
ffffffffc0204ec6:	0785                	addi	a5,a5,1
ffffffffc0204ec8:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc0204ecc:	fec79de3          	bne	a5,a2,ffffffffc0204ec6 <memset+0x6>
    }
    return s;
...
ffffffffc0204ed2 <memcpy>:
    ...
    char *d = dst;
    while (n -- > 0) {
ffffffffc0204ed2:	ca19                	beqz	a2,ffffffffc0204ee8 <memcpy+0x16>
ffffffffc0204ed4:	962e                	add	a2,a2,a1
    char *d = dst;
ffffffffc0204ed6:	87aa                	mv	a5,a0
        *d ++ = *s ++;
ffffffffc0204ed8:	0005c703          	lbu	a4,0(a1)
ffffffffc0204edc:	0585                	addi	a1,a1,1
ffffffffc0204ede:	0785                	addi	a5,a5,1
ffffffffc0204ee0:	fee78fa3          	sb	a4,-1(a5)
    while (n -- > 0) {
ffffffffc0204ee4:	fec59ae3          	bne	a1,a2,ffffffffc0204ed8 <memcpy+0x6>
    }
    return dst;
...
memcmp(const void *v1, const void *v2, size_t n) {
    ...
    while (n -- > 0) {
ffffffffc0204eea:	c205                	beqz	a2,ffffffffc0204f0a <memcmp+0x20>
ffffffffc0204eec:	962e                	add	a2,a2,a1
ffffffffc0204eee:	a019                	j	ffffffffc0204ef4 <memcmp+0xa>
ffffffffc0204ef0:	00c58d63          	beq	a1,a2,ffffffffc0204f0a <memcmp+0x20>
        if (*s1 != *s2) {
ffffffffc0204ef4:	00054783          	lbu	a5,0(a0)
ffffffffc0204ef8:	0005c703          	lbu	a4,0(a1)
            return (int)((unsigned char)*s1 - (unsigned char)*s2);
        }
        s1 ++, s2 ++;
ffffffffc0204efc:	0505                	addi	a0,a0,1
ffffffffc0204efe:	0585                	addi	a1,a1,1
        if (*s1 != *s2) {
ffffffffc0204f00:	fee788e3          	beq	a5,a4,ffffffffc0204ef0 <memcmp+0x6>
            return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204f04:	40e7853b          	subw	a0,a5,a4
ffffffffc0204f08:	8082                	ret
    }
    return 0;
ffffffffc0204f0a:	4501                	li	a0,0
}
