...
ffffffffc020321c:	08b00593          	li	a1,139
...
ffffffffc020323c:	0a200593          	li	a1,162
...
ffffffffc020325c:	0a000593          	li	a1,160
...
ffffffffc020327c:	09f00593          	li	a1,159
...
ffffffffc020329c:	09d00593          	li	a1,157
...
ffffffffc02032bc:	09b00593          	li	a1,155
...
ffffffffc02032dc:	09900593          	li	a1,153
...
ffffffffc02032fc:	09700593          	li	a1,151
...
ffffffffc020331c:	09500593          	li	a1,149
...
ffffffffc020333c:	09300593          	li	a1,147
...
ffffffffc020335c:	09100593          	li	a1,145
...
ffffffffc020337c:	08f00593          	li	a1,143
...
ffffffffc020339c:	08d00593          	li	a1,141
...
ffffffffc02033b4:	c385                	beqz	a5,ffffffffc02033d4 <_clock_map_swappable+0x28>
    list_add((&pra_list_head) -> prev, entry);
ffffffffc02033b6:	0000e797          	auipc	a5,0xe
ffffffffc02033ba:	d327b783          	ld	a5,-718(a5) # ffffffffc02110e8 <pra_list_head>
    __list_add(elm, listelm, listelm->next);
ffffffffc02033be:	6794                	ld	a3,8(a5)
ffffffffc02033c0:	03060713          	addi	a4,a2,48
}
ffffffffc02033c4:	4501                	li	a0,0
    prev->next = next->prev = elm;
ffffffffc02033c6:	e298                	sd	a4,0(a3)
ffffffffc02033c8:	e798                	sd	a4,8(a5)
    elm->prev = prev;
ffffffffc02033ca:	fa1c                	sd	a5,48(a2)
    page->visited=1;
ffffffffc02033cc:	4785                	li	a5,1
    elm->next = next;
ffffffffc02033ce:	fe14                	sd	a3,56(a2)
ffffffffc02033d0:	ea1c                	sd	a5,16(a2)
}
...
ffffffffc02033da:	7c268693          	addi	a3,a3,1986 # ffffffffc0205b98 <default_pmm_manager+0xa80>
ffffffffc02033de:	00002617          	auipc	a2,0x2
ffffffffc02033e2:	98a60613          	addi	a2,a2,-1654 # ffffffffc0204d68 <commands+0x738>
ffffffffc02033e6:	03700593          	li	a1,55
ffffffffc02033ea:	00002517          	auipc	a0,0x2
ffffffffc02033ee:	74e50513          	addi	a0,a0,1870 # ffffffffc0205b38 <default_pmm_manager+0xa20>
{
ffffffffc02033f2:	e406                	sd	ra,8(sp)
    assert(entry != NULL && curr_ptr != NULL);
ffffffffc02033f4:	f81fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc02033f8 <_clock_swap_out_victim>:
         assert(head != NULL);
ffffffffc02033f8:	751c                	ld	a5,40(a0)
{
...
ffffffffc0203400:	e426                	sd	s1,8(sp)
         assert(head != NULL);
ffffffffc0203402:	cfa9                	beqz	a5,ffffffffc020345c <_clock_swap_out_victim+0x64>
     assert(in_tick==0);
ffffffffc0203404:	ee25                	bnez	a2,ffffffffc020347c <_clock_swap_out_victim+0x84>
ffffffffc0203406:	0000e497          	auipc	s1,0xe
ffffffffc020340a:	15248493          	addi	s1,s1,338 # ffffffffc0211558 <curr_ptr>
ffffffffc020340e:	852e                	mv	a0,a1
ffffffffc0203410:	4701                	li	a4,0
ffffffffc0203412:	608c                	ld	a1,0(s1)
ffffffffc0203414:	0000e697          	auipc	a3,0xe
ffffffffc0203418:	cd468693          	addi	a3,a3,-812 # ffffffffc02110e8 <pra_list_head>
ffffffffc020341c:	a029                	j	ffffffffc0203426 <_clock_swap_out_victim+0x2e>
            page->visited=0;
ffffffffc020341e:	fe05b023          	sd	zero,-32(a1) # fe0 <kern_entry-0xffffffffc01ff020>
    return listelm->next;
ffffffffc0203422:	85a2                	mv	a1,s0
    while (1) {
ffffffffc0203424:	4705                	li	a4,1
ffffffffc0203426:	6580                	ld	s0,8(a1)
        if(curr_ptr != &pra_list_head){
ffffffffc0203428:	fed58de3          	beq	a1,a3,ffffffffc0203422 <_clock_swap_out_victim+0x2a>
        	if(!(page->visited)){
ffffffffc020342c:	fe05b783          	ld	a5,-32(a1)
ffffffffc0203430:	f7fd                	bnez	a5,ffffffffc020341e <_clock_swap_out_victim+0x26>
ffffffffc0203432:	c311                	beqz	a4,ffffffffc0203436 <_clock_swap_out_victim+0x3e>
ffffffffc0203434:	e08c                	sd	a1,0(s1)
    __list_del(listelm->prev, listelm->next);
ffffffffc0203436:	619c                	ld	a5,0(a1)
        	struct Page * page = le2page(curr_ptr, pra_page_link);
ffffffffc0203438:	fd058713          	addi	a4,a1,-48
    prev->next = next;
ffffffffc020343c:	e780                	sd	s0,8(a5)
    next->prev = prev;
ffffffffc020343e:	e01c                	sd	a5,0(s0)
            	*ptr_page = page;
ffffffffc0203440:	e118                	sd	a4,0(a0)
            	cprintf("curr_ptr %p\n",curr_ptr);
ffffffffc0203442:	00002517          	auipc	a0,0x2
ffffffffc0203446:	79e50513          	addi	a0,a0,1950 # ffffffffc0205be0 <default_pmm_manager+0xac8>
ffffffffc020344a:	c71fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
}
ffffffffc020344e:	60e2                	ld	ra,24(sp)
            	curr_ptr=next_ptr;
ffffffffc0203450:	e080                	sd	s0,0(s1)
}
ffffffffc0203452:	6442                	ld	s0,16(sp)
ffffffffc0203454:	64a2                	ld	s1,8(sp)
...
ffffffffc0203460:	76468693          	addi	a3,a3,1892 # ffffffffc0205bc0 <default_pmm_manager+0xaa8>
ffffffffc0203464:	00002617          	auipc	a2,0x2
ffffffffc0203468:	90460613          	addi	a2,a2,-1788 # ffffffffc0204d68 <commands+0x738>
ffffffffc020346c:	04900593          	li	a1,73
ffffffffc0203470:	00002517          	auipc	a0,0x2
ffffffffc0203474:	6c850513          	addi	a0,a0,1736 # ffffffffc0205b38 <default_pmm_manager+0xa20>
ffffffffc0203478:	efdfc0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(in_tick==0);
ffffffffc020347c:	00002697          	auipc	a3,0x2
ffffffffc0203480:	75468693          	addi	a3,a3,1876 # ffffffffc0205bd0 <default_pmm_manager+0xab8>
ffffffffc0203484:	00002617          	auipc	a2,0x2
ffffffffc0203488:	8e460613          	addi	a2,a2,-1820 # ffffffffc0204d68 <commands+0x738>
ffffffffc020348c:	04a00593          	li	a1,74
ffffffffc0203490:	00002517          	auipc	a0,0x2
ffffffffc0203494:	6a850513          	addi	a0,a0,1704 # ffffffffc0205b38 <default_pmm_manager+0xa20>
